...
func NewJWTer(s Store, c clock.Clocker) (*JTWer, error) {
	j := &JTWer{Store: s}
...
func (j *JTWer) GenerateToken(ctx context.Context, u entity.User) ([]byte, error) {
	tok, err := jwt.NewBuilder().
		JwtID(uuid.New().String()).
		Issuer(`github.com/homm509/go_todo_app`).
...
func (j *JTWer) GetToken(ctx context.Context, r *http.Request) (jwt.Token, error) {
...
func (j *JTWer) FillContext(r *http.Request) (*http.Request, error) {
